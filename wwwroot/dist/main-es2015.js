...
const routes = [
    ...
    { path: 'my-route', component: _counter_counter_component__WEBPACK_IMPORTED_MODULE_10__["CounterComponent"] },
...
let FetchDataComponent = class FetchDataComponent {
    ...
    loadInspectionPlans() {
        this.http.get(this.baseUrl + 'api/InspectionPlans').subscribe(result => {
    ...
    ;
    loadEquipments() {
        this.http.get(this.baseUrl + 'api/Equipments').subscribe(result => {
            this.equipments = result;
            console.log(this.equipments);
        }, error => console.error(error));
    }
    loadCalibrations() {
        this.http.get(this.baseUrl + 'api/Calibrations').subscribe(result => {
...
module.exports = __webpack_require__(/*! D:\Examen3\ClientApp\src\main.ts */"./src/main.ts");
