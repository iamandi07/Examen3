...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentsEditComponent", function() { return EquipmentsEditComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _equipments_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../equipments.service */ "./src/app/equipments/equipments.service.ts");
...
let EquipmentsEditComponent = class EquipmentsEditComponent {
    constructor(router, route, equipmentsService, formBuilder) {
        this.router = router;
        this.route = route;
    ...
    save() {
        ...
        if (this.formGroup.valid) {
            let equipment = this.formGroup.value;
...
EquipmentsEditComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _equipments_service__WEBPACK_IMPORTED_MODULE_3__["EquipmentsService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }
];
EquipmentsEditComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-equipments-edit',
        template: __importDefault(__webpack_require__(/*! raw-loader!./equipments-edit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/equipments/equipments-edit/equipments-edit.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./equipments-edit.component.css */ "./src/app/equipments/equipments-edit/equipments-edit.component.css")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        _equipments_service__WEBPACK_IMPORTED_MODULE_3__["EquipmentsService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EquipmentsListComponent", function() { return EquipmentsListComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _equipments_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../equipments.service */ "./src/app/equipments/equipments.service.ts");
...
let EquipmentsListComponent = class EquipmentsListComponent {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.equipmentsService.listEquipments().subscribe(res => {
                    this.equipments = res;
                    this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.equipments);
                    this.isloading = true;
...
EquipmentsListComponent.ctorParameters = () => [
...
], EquipmentsListComponent.prototype, "paginator", void 0);
EquipmentsListComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-equipments-list',
        template: __importDefault(__webpack_require__(/*! raw-loader!./equipments-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/equipments/equipments-list/equipments-list.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./equipments-list.component.css */ "./src/app/equipments/equipments-list/equipments-list.component.css")).default]
    }),
    __metadata("design:paramtypes", [_equipments_service__WEBPACK_IMPORTED_MODULE_1__["EquipmentsService"]])
...
/* harmony import */ var _equipments_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./equipments.component */ "./src/app/equipments/equipments.component.ts");
/* harmony import */ var _equipments_list_equipments_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./equipments-list/equipments-list.component */ "./src/app/equipments/equipments-list/equipments-list.component.ts");
/* harmony import */ var _equipments_edit_equipments_edit_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./equipments-edit/equipments-edit.component */ "./src/app/equipments/equipments-edit/equipments-edit.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
const routes = [
    {
        path: '', component: _equipments_component__WEBPACK_IMPORTED_MODULE_2__["EquipmentsComponent"],
        children: [
            { path: '', redirectTo: 'list', pathMatch: 'full' },
            { path: 'list', component: _equipments_list_equipments_list_component__WEBPACK_IMPORTED_MODULE_3__["EquipmentsListComponent"] },
            { path: 'edit/:id', component: _equipments_edit_equipments_edit_component__WEBPACK_IMPORTED_MODULE_4__["EquipmentsEditComponent"] },
            { path: 'edit', component: _equipments_edit_equipments_edit_component__WEBPACK_IMPORTED_MODULE_4__["EquipmentsEditComponent"] },
        ]
    }
];
...
EquipmentsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./equipments.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/equipments/equipments.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./equipments.component.css */ "./src/app/equipments/equipments.component.css")).default]
    }),
...
/* harmony import */ var _equipments_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./equipments-routing.module */ "./src/app/equipments/equipments-routing.module.ts");
/* harmony import */ var _equipments_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./equipments.service */ "./src/app/equipments/equipments.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
EquipmentsModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        imports: [
            ...
            _equipments_routing_module__WEBPACK_IMPORTED_MODULE_5__["EquipmentsRoutingModule"],
...
let EquipmentsService = class EquipmentsService {
    ...
    getEquipment(id) {
        return this.http.get(`${this.applicationService.baseUrl}api/Equipments/${id}`);
    }
    listEquipments() {
        return this.http.get(`${this.applicationService.baseUrl}api/Equipments`);
    }
    ...
    deleteEquipment(id) {
        return this.http.delete(`${this.applicationService.baseUrl}api/Equipments/${id}`);
    }
};
...
//# sourceMappingURL=equipments-equipments-module-es2015.js.map