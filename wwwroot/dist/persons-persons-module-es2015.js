...
/* harmony import */ var _persons_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../persons.service */ "./src/app/persons/persons.service.ts");
...
let PersonsEditComponent = class PersonsEditComponent {
    constructor(router, route, personsService, formBuilder) {
        this.router = router;
        this.route = route;
...
PersonsEditComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-persons-edit',
        template: __importDefault(__webpack_require__(/*! raw-loader!./persons-edit.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/persons/persons-edit/persons-edit.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./persons-edit.component.css */ "./src/app/persons/persons-edit/persons-edit.component.css")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
        _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        _persons_service__WEBPACK_IMPORTED_MODULE_3__["PersonsService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _persons_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../persons.service */ "./src/app/persons/persons.service.ts");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this.personsService.listPersons().subscribe(res => {
                    this.persons = res;
                    this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.persons);
                    this.isloading = true;
...
PersonsListComponent.ctorParameters = () => [
...
], PersonsListComponent.prototype, "paginator", void 0);
PersonsListComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-persons-list',
        template: __importDefault(__webpack_require__(/*! raw-loader!./persons-list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/persons/persons-list/persons-list.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./persons-list.component.css */ "./src/app/persons/persons-list/persons-list.component.css")).default]
    }),
    __metadata("design:paramtypes", [_persons_service__WEBPACK_IMPORTED_MODULE_1__["PersonsService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PersonsRoutingModule", function() { return PersonsRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _persons_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./persons.component */ "./src/app/persons/persons.component.ts");
/* harmony import */ var _persons_list_persons_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./persons-list/persons-list.component */ "./src/app/persons/persons-list/persons-list.component.ts");
/* harmony import */ var _persons_edit_persons_edit_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./persons-edit/persons-edit.component */ "./src/app/persons/persons-edit/persons-edit.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
const routes = [
    {
        path: '', component: _persons_component__WEBPACK_IMPORTED_MODULE_2__["PersonsComponent"],
        children: [
            { path: '', redirectTo: 'list', pathMatch: 'full' },
            { path: 'list', component: _persons_list_persons_list_component__WEBPACK_IMPORTED_MODULE_3__["PersonsListComponent"] },
            { path: 'edit/:id', component: _persons_edit_persons_edit_component__WEBPACK_IMPORTED_MODULE_4__["PersonsEditComponent"] },
            { path: 'edit', component: _persons_edit_persons_edit_component__WEBPACK_IMPORTED_MODULE_4__["PersonsEditComponent"] },
        ]
    }
];
let PersonsRoutingModule = class PersonsRoutingModule {
};
...
PersonsRoutingModule = __decorate([
...
PersonsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./persons.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/persons/persons.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./persons.component.css */ "./src/app/persons/persons.component.css")).default]
    }),
...
/* harmony import */ var _persons_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./persons-routing.module */ "./src/app/persons/persons-routing.module.ts");
/* harmony import */ var _persons_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./persons.service */ "./src/app/persons/persons.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
PersonsModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        ...
        imports: [
            ...
            _persons_routing_module__WEBPACK_IMPORTED_MODULE_5__["PersonsRoutingModule"],
...
let PersonsService = class PersonsService {
    ...
    getPerson(id) {
        return this.http.get(`${this.applicationService.baseUrl}api/People/${id}`);
    }
    listPersons() {
        return this.http.get(`${this.applicationService.baseUrl}api/People`);
    }
    savePerson(person) {
    ...
    deletePerson(id) {
        return this.http.delete(`${this.applicationService.baseUrl}api/People/${id}`);
    }
};
...
//# sourceMappingURL=persons-persons-module-es2015.js.map