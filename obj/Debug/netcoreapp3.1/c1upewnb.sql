...
BEGIN
    CREATE TABLE [InspectionPlans] (
        ...
        CONSTRAINT [FK_InspectionPlans_Persons_PersonId] FOREIGN KEY ([PersonId]) REFERENCES [Persons] ([Id]) ON DELETE CASCADE
    );
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200703204225_Equipments')
BEGIN
    CREATE TABLE [Equipments] (
        ...
        CONSTRAINT [FK_Equipments_Persons_PersonId] FOREIGN KEY ([PersonId]) REFERENCES [Persons] ([Id]) ON DELETE CASCADE
    );
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200703204225_Equipments', N'3.1.5');
END;
